      ...
      <div className="container mx-auto px-4 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-start">
          <div className="lg:col-span-4 flex gap-2 sm:gap-8">
            <FooterDetailItem title="상호명" krDescription={company.name.kr} enDescription={company.name.in} />

            <FooterDetailItem title="대표 CEO" krDescription={company.ceo.kr} enDescription={company.ceo.en} />
          </div>
          ...
          <FooterDetailItem
            title="주소 ADDRESS"
            className="flex flex-col gap-1 lg:col-span-6"
