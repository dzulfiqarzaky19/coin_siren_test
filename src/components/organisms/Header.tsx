          ...
          <div className="relative group cursor-pointer">
            ...
            <div className="absolute top-full left-0 mt-2 w-[240px] bg-white rounded-lg shadow-xl text-gray-800 p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
              ...
              <ul className="space-y-3 text-gray-600">
                <Typography as="li" variant="caption" className="cursor-pointer hover:text-blue-600 font-medium">
                  해외 개발자 원격 채용
                </Typography>
                <Typography as="li" variant="caption" className="cursor-pointer hover:text-blue-600 font-medium">
                  외국인 원격 채용 (비개발 직군)
              ...
              <nav className="flex flex-col gap-6">
                <motion.div
                  ...
                  <Typography
                    ...
                    variant="h3"
                    weight="bold"
                    className="text-gray-900 border-b pb-2 flex items-center justify-between">
                    채용
                  </Typography>
