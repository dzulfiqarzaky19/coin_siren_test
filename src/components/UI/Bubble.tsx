...
export const Bubble = ({ children, className = '', arrowPosition = 'center' }: IBubbleProps) => {
  ...
  const finalArrowClasses = cn(arrowBaseClasses, positionClasses[arrowPosition]);

  return (
    <div className={cn('relative', className)}>
      <div className={cn(baseClass, finalArrowClasses, 'inline-flex')}>{children}</div>
    </div>
  );
};
